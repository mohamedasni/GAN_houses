...
generator.add(Dense(60, activation='relu', kernel_regularizer=L1L2(1e-5, 1e-5)))
generator.add(Dense(80, activation='relu', kernel_regularizer=L1L2(1e-5, 1e-5)))
generator.add(Dense(60, activation='relu', kernel_regularizer=L1L2(1e-5, 1e-5)))
...
discriminator.add(Dense(50, activation='relu', kernel_regularizer=L1L2(1e-5, 1e-5)))
discriminator.add(Dense(70, activation='relu', kernel_regularizer=L1L2(1e-5, 1e-5)))
discriminator.add(Dropout(0.05))
discriminator.add(Dense(100, activation='relu', kernel_regularizer=L1L2(1e-5, 1e-5)))
discriminator.add(Dense(70, activation='relu', kernel_regularizer=L1L2(1e-5, 1e-5)))
discriminator.add(Dense(40, activation='relu', kernel_regularizer=L1L2(1e-5, 1e-5)))
...
test = model.fit(x=x_train, y=gan_targets(np.array(x_train).shape[0]), epochs=100, batch_size=50, shuffle=True)
